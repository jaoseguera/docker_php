...
!function ($) {
  ...
  * ==================== */
  ...
  $(function () {
	  ...
	  $('.level-3,.sales_dashbord').click(function ()
	  {
...
var $this = $(this), href, target = $this.attr('data-target') || e.preventDefault()|| (href = $this.attr('href')) && href.replace(/.*(?=#[^\s]+$)/, '') //strip for ie7
		...
		//alert($('.sidebar-toggle').hasClass('user-active-bars'));
		...
		{
            $('#nav_tab').show();
			$('.sidebar-toggle').addClass('user-active-bars');
...
$(document).ready(function(e) {
	if($(document).width()<1024)
	{
		...
		//$('#logform input').each(function(index, element) {
        
	//$(this).attr('placeholder',$(this).attr('alt'));
   // });
   // $('#validation input[type=text]').each(function(index, element) {
