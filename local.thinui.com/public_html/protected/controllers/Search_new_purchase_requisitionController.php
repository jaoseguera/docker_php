<?php
class Search_new_purchase_requisitionController extends Controller
{
    /**
    ...
    **/        
    ...
    public function actionSearch_new_purchase_requisition()
    {
        
        if(Yii::app()->user->hasState("login"))
        {
            $model = new Search_new_purchase_requisitionForm;
