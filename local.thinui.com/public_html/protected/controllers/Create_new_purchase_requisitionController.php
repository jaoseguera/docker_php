<?php
class Create_new_purchase_requisitionController extends Controller
{
    /**
    ...
    **/
    public function actionCreate_new_purchase_requisition()
    {
        if(Yii::app()->user->hasState("login"))
        {
            $model = new Create_new_purchase_requisitionForm;            
            if(isset($_POST['page']))
            {
                global $rfc, $fce;
