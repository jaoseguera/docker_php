...
class Create_customers_masterController extends Controller
{
    /**
    ...
    **/
    public function actionCreate_customers_master()
    {
    ...
    public function actionCreatecustomer()
    {
        if(Yii::app()->user->hasState("login"))
        {
            ...
            $b = new Bapi();
            $b->bapiCall($bapiName);
            Yii::app()->controller->renderPartial('createcustomer',array('model'=>$model));
        }
        else{
            $this->redirect(array('login/'));
        }
