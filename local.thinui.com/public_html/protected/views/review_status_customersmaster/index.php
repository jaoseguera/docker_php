...
$customize 	= $model;
	...
	$va=preg_match('/"'.'approvecustomers'.'"/i' , json_encode($rol));
	if($va==1)
	{
...
<section id='utopia-wizard-form' class="utopia-widget utopia-form-box">
    <div class="row-fluid">
        <div class="utopia-widget-content" style="z-index:100;">
            <form id="validation" action="" onsubmit='javascript:return getBapitable("example40_today","ZMDRHDR","example40","L","show_menu@<?php echo 1032;?>","Review_status_customersmaster","submit")'  class="form-horizontal">
                <input type="hidden" name="url" value="customer_master_review"/>
                <input type="hidden" name="btn" value="btn-primary"/>
                    <div class="span5 utopia-form-freeSpace">
                        <fieldset >
                            <div class="control-group">
                                <label class="control-label cutz" for="input01" alt='Customer Number'><?php echo Controller::customize_label('THINUI User ID');?><span> *</span>:</label>
                                <div class="controls myspace1">
                                <select id="Users" data-placeholder="Select User"  class="input-fluid  minw1 read select_box1"  tabindex="8" name="Users" style="height:30px;">
									<?php if($va==1) { ?>
									<option value=""></option>
									<?php
							...
							<div class="control-group">
								<label class="control-label cutz" for="date" alt='Postal Date'><?php echo Controller::customize_label('From Date');?>:</label>
								<div class="controls">
									<input class="input-fluid  minw1 span6" type="text"  name="F_DATE"  id='datepicker' > 
								</div>
							</div>
						</fieldset>
                    </div>
					<div class="span5 utopia-form-freeSpace">
						<fieldset>
						<div class="control-group">
                                <label class="control-label cutz" for="input01" alt='Customer Number'><?php echo Controller::customize_label('Status');?>:</label>
                                <div class="controls myspace1">
                                <select id="Status" data-placeholder="Select Status"  class="input-fluid  minw1 read select_box1" tabindex="8" name="Status" style="height:30px;">
									<option value=""></option>
						...
						<div class="control-group">
							<label class="control-label cutz" for="date" alt='Postal Date'><?php echo Controller::customize_label('To Date');?>:</label>
							<div class="controls">
								<input class="input-fluid  minw1 span6" type="text"  name="T_DATE"  id='datepicker1' > 
							</div>
						</div>
						</fieldset>
					</div>
        ...
        <div class="utopia-widget-content utopia-form-tabs" >
            <div class="tabbable" >
                <ul class="nav nav-tabs menu_tab">
                    <li id='li_2' class="active"><a href="#tab42" data-toggle="tab" id="t42"  class="cutz" alt='Orders'><?php echo Controller::customize_label('Customer List');?></a></li>
                    <li id='li_1' ><a href="#tab41"  id="t41" class="cutz" alt='Customer Details'><?php echo Controller::customize_label('Customer Details');?></a></li>
...
$('#tab42').css({display:'none'});
  ...
  $("body").css("filter","alpha(opacity=40)"); 
   ...
   $.ajax(
    {
        type:'POST', 
        url: 'review_status_customersmaster/customer_details',
