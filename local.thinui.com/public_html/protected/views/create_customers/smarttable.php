<div id="fil_pop">
    ...
    <button onClick="filter()" class="btn"  id="subt" style="width:90px; float:right; margin-top:5px;margin-right:20px;"><?=_SUBMIT?></button>
...
<div id="sort_pop">
    ...
    <button class="cancel btn" style="width:90px;float:right;margin-right:10px; margin-top:5px;" onclick="cancel_pop()"><?=_CANCEL?></button>
    <button onClick="sort_ch()" class="btn"  id="stt" style="width:90px; float:right; margin-top:5px;margin-right:20px;"><?=_SUBMIT?></button>
    <button  onClick="st_id()" id="st_id" class="btn"  style="display:none;width:90px;float:right; margin-top:5px;margin-right:15px;"><?=_SORT?></button>
</div>
