            ...
            <div class="row-fluid">
                ...
                <div class="utopia-login" >
                    ...
                    <div class="form">
                        ...
                        <div id='form'>
							<div>
								<?php echo $form->labelEx($model, 'bapi_tech_name'); ?>
								<?php echo $form->textField($model, 'bapi_tech_name', array('class' => 'validate[required] utopia-fluid-input span12', 'onKeyUp' => "jspt(this.id, this.value,event)")); ?>
								<?php echo $form->hiddenField($model, 'bapiName'); ?>
								<?php echo $form->error($model, 'bapi_tech_name'); ?>
							</div>
							<div>
            ...
            $("#login-form").validationEngine({
                onValidationComplete: function(form, status)
                {
                    ...
                    if(status)
                    {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: '<?php echo Yii::app()->createAbsoluteUrl("tableheaders/store"); ?>',
                            data: form.serialize(),
