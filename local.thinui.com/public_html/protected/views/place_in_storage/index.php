							...
							<tbody>
								<tr onClick="select_row('ids_0')" class="ids_0 nudf" >
									...
									<td>
                                        ...
                                        <div class='minws' id="table_lookup"  onclick="lookup('Storage Location', 'STGE_LOC', 'storage_loc')" >&nbsp;</div>
									</td>
									<td>
...
function addRow(tableID,t) 
{
    ...
    for(var i=0; i<colCount; i++)
    {
        ...
        if(ind[0].title=='Storage_location')
        {
            ...
            var su='STGE_LOC'+nut;
            re[0].style.display=''
            re[0].setAttribute("onclick","lookup('Storage Location', '"+su+"', 'storage_loc');");
        }
   ...
   function deleteRow(tableID)
   {
       ...
       $('#'+tableID+" tbody tr").each(function(index, element)
       {
           ...
           $(this).find('span').each(function(spanindex, spanelement)
           {
               ...
               if(spanindex == 3)
                   $(this).attr("onclick", "lookup('Storage Location', '"+newid+"', 'storage_loc')");
