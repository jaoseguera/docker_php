         ...
         <div class="nav-collapse collapse" id="nav_tab" >
            ...
            <ul class="accordion level-1">
              <li class="topli sales_dashbord"><a  href="#" id='avl_sys_nav' onClick="shows_betarequest('avl_sys')" ><span>Beta user requests</span></a></li>
                         ...
                         <li class="current sales_dashbord active"><a  href="#" id='add_sys_nav' onClick="shows_feedback('add_sys')"><span>Feedback</span></a></li>
...
{
    foreach($values['feedback'] as $kk=>$vv)
    { $rows[]=$vv['Name'];
    ?>
        ...
        <td colspan="4"><?php echo $vv['FeedBack'];?></td>
        </tr>
    <?php }
 }
  if(empty($rows))
