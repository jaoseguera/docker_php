<?php
	...
	$finance_reports = $doc->reports->$System_ID->$Client_ID->finance_reports;
        ...
        <section id='utopia-wizard-form' class="utopia-widget utopia-form-box" >
            <div class="row-fluid">
				<div class="contt span12">
					<ul class="ullink">
						<?php
							foreach($all_reports['finance'] as $key => $val)
							{
								if(isset($finance_reports))
								{
									if(isset($finance_reports->$key) && !empty($finance_reports->$key))
										echo "<li><a href='".$finance_reports->$key."' target='_blank' class='report_link' id='".$key."' onmousedown='mosds(event,this)'>".$val."</a></li>";
									else
