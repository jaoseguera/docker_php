    ...
    <div id='fil_center'>
        <table border="0" id="contnt" width="100%">
            <tr>
                ...
                <td width="10%" align="center" class="center">
...
<div id="sort_pop">
    ...
    <div id='sort_center'>
        <table border="0" class="contnt" width="100%">
            <tr>
                ...
                <td width="10%" align="center" class="center"><div class="to_left"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/to_left.png" style="cursor:pointer"></div>
    ...
    <button class="cancel btn" style="width:90px;float:right;margin-right:10px; margin-top:5px;" onclick="cancel_pop()">Cancel</button>
    <button onClick="sort_ch()" class="btn"  id="stt" style="width:90px; float:right; margin-top:5px;margin-right:20px;">Submit</button>
    <button  onClick="st_id()" id="st_id" class="btn"  style="display:none;width:90px;float:right; margin-top:5px;margin-right:15px;">Sort</button>
</div>
