 ...
 **/
class Picking_and_post-esign_Form extends CFormModel
{
    public $username;
    public $password;
    public $rememberMe;
    ...
    **/
	...
	public function _actionPostSubmit($doc, $screen, $fce)
	{
		...
		{
			$VBE[$i_vbeln][] = array('VBELN'=>$_REQUEST['I_VBELN'],'POSNR'=>$val,'MATNR'=>$material[$key],'LFIMG'=>$delivery_qu[$key],'WERKS'=>$plant[$key]);
			$T_LIPS = array("VBELN"=>$i_vbeln,"POSNR"=>$val,"MATNR"=>strtoupper($material[$key]),'LFIMG'=>$delivery_qu[$key]);
