<?php
class Purchasing_reportsController extends Controller
{
    /**
    ...
    **/
    ...
    public function actionPurchasing_reports()
    {
	...
	public function actionSaveurl()
    {
		...
		$doc->reports->$System_ID->$Client_ID->purchasing_reports->$id = $url;
