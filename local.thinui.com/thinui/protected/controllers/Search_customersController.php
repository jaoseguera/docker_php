<?php
class Search_customersController extends Controller
{
    /**
    ...
    public function actions()
    {
	 ...
	 public function actionTabledata() {
		 if (Yii::app()->user->hasState("login")) {
            global $rfc, $fce;
            $model = new Search_customersForm;
    ...
    **/
    public function actionSearch_customers()
    {
        if(Yii::app()->user->hasState("login"))
        {
            $model = new CommonForm;
			$models = new Search_customersForm;
			$userid = Yii::app()->user->getState('user_id');
            $client = Controller::userDbconnection();
			$doc = $client->getDoc($userid);
			$screen = CommonController::setScreen();
    ...
    public function actionCustomermap()
    {
        ...
        {            
            ...
            Yii::app()->controller->renderPartial('customermap',array('model'=>$model,'fce'=>$fce));
        }
        else{
            $this->redirect(array('login/'));
        }
