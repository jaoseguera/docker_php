...
?><section id='utopia-wizard-form' class="utopia-widget utopia-form-box">
    <div class="row-fluid">
        <div class="utopia-widget-content inval38">
            <form id="validation" onsubmit='javascript:return getBapitable("table_todays","ZBAPI_RVKRED_TS_POST","examples","L","show_menu@<?php echo $s_wid;?>","Sales_order_credit_block","submit")' class="form-horizontal">
                <input type="hidden" name='page' value="bapi">
                <input type="hidden" name="url" value="sales_order_credit_block"/>
                
                <input type="hidden" class='tbName_examples' value='ZBAPI_RVKRED_TS_POST'>
                ...
                <fieldset class="span12 iphone_sales_textBox" >
                    ...
                    <div class="span3 utopia-form-freeSpace">
                        <fieldset>
                            <label style="text-align: left;" class="control-label cutz" alt="Sales Organization" for="inputError"><?=Controller::customize_label(_CREDITCONTROLAREA);?><span> *</span>:</label>
                    ...
                    <div class="span3 utopia-form-freeSpace">
                        ...
                        <label class="control-label cutz" for="input01" alt='Sale Order Number' ><?=Controller::customize_label(_SALEORDERNUMBER);?>:&nbsp;</label>
                           <input style='min-width:170px;' id='I_VBELN' class="input-fluid  " type="text" name='I_VBELN' value="<?php echo $I_VBELN_TXT; ?>"><!-- onChange="numdef(this.value,this.id)">-->
            ...
            <div>
                <div>
                    ...
                    // if($SalesOrder==NULL) {
                        ...
                        <div class='testr table_todays' onClick='getBapitable("table_todays","ZBAPI_RVKRED_TS_POST","examples","S","show_menu@<?php echo $s_wid;?>","Sales_order_credit_block","submit")'><?=_SHOWMORE?></div>
