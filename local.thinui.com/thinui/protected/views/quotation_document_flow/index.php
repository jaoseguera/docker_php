...
<input type="submit" value="<?php echo _SUBMIT ?>" style="min-width:90px;margin-top:48px" class="btn btn-primary  bbt back_b iphone_sales_submit iphone_Sale_submit" id="submit" name="submit">
			</fieldset>
