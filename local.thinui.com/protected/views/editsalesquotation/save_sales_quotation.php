<?php
	...
	foreach($item as $keys=>$vals)
	{
		...
		array_push($importTableCONDITIONSIN, $CONDITIONS_IN);
		//.................................................................................
		...
		$SCHEDULE_LINES=array("ITM_NUMBER"=>$vals,"SCHED_LINE"=>$i,"REQ_QTY"=>$Order_quantity[$keys]);
		array_push($importTableScheduleLINES,$SCHEDULE_LINES);		
		//.................................................................................

		$SCHEDULE_LINESX=array("ITM_NUMBER"=>$vals,"SCHED_LINE"=>$i,"UPDATEFLAG"=>$fg[1],"REQ_QTY"=>"X");
		array_push($importTableScheduleLINESX,$SCHEDULE_LINESX);
		//.................................................................................
		// $i++;
		$j++;
	}
	...
	$res = $fce->invoke(["SALESDOCUMENT"=>$i_vbeln,
						...
						"CONDITIONS_IN"=>$importTableCONDITIONSIN,
						"CONDITIONS_INX"=>$importTableCONDITIONSINX,
						"PARTNERCHANGES"=>$importTablePARTNERCHANGES
						"SCHEDULE_LINES"=>$importTableScheduleLINES,
						"SCHEDULE_LINESX"=>$importTableScheduleLINESX],$options);	
