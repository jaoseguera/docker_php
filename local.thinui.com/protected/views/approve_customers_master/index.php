...
<section id='utopia-wizard-form' class="utopia-widget utopia-form-box">
    <div class="row-fluid">
        <div class="utopia-widget-content" style="z-index:100;">
            <form id="validation" action="" onsubmit='javascript:return getBapitable("example40_today","ZMDRHDR","example40","L","show_menu@<?php echo 1032;?>","Approve_customers_master","submit")'  class="form-horizontal">
                <input type="hidden" name="url" value="customer_master_review"/>
                <input type="hidden" name="btn" value="btn-primary"/>
				<div class="span12">
                    <div class="span4 utopia-form-freeSpace myspace1">
                        <fieldset >
                            <div class="control-group">
                                ...
                                <select id="Users" data-placeholder="Select User"  class="input-fluid  minw1 read select_box1"  tabindex="8" name="Users" style="height:30px;width:120%">
									<option value=""></option>
									<?php
					...
					<div class="span4 utopia-form-freeSpace myspace1">
						...
						<div class="controls">
						<input class="input-fluid  minw1 " type="text"  name="F_DATE"  id='datepicker' > 
						</div>
						</div>
					...
					<div class="span4 utopia-form-freeSpace myspace1">
						...
						<div class="controls">
						<input class="input-fluid  minw1 " type="text"  name="T_DATE"  id='datepicker1' > 
						</div>
						</div>
						</fieldset>
                    </div>
        ...
        <div class="utopia-widget-content utopia-form-tabs" >
            <div class="tabbable" >
                <ul class="nav nav-tabs menu_tab">
                    <li id='li_2' class="active"><a href="#tab42" data-toggle="tab" id="t42" onclick='return getBapitable("example40_today","ZMDRHDR","example40","L","show_menu@<?php echo 1032;?>","Approve_customers_master","submit")'  class="cutz" alt='Orders'><?php echo Controller::customize_label('Pending Approvals');?></a></li>
...
$(document).ready(function() 
{
$('#datepicker, #datepicker1,#create_date,#update_date').datepicker({
format: 'mm/dd/yyyy',
weekStart: '0',
        autoclose:true
...
function change(vl)
{
   ...
   $.ajax(
    {
        type:'POST', 
        url: 'approve_customers_master/customer_details',
