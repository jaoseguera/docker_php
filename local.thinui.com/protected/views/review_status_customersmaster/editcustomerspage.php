...
getBapitable("example40_today","ZMDRHDR","example40","L","show_menu@<?php echo 1032;?>","Review_status_customersmaster","submit");
}
$(document).ready(function() {
...
function edit_customer()
{
    ...
    $.ajax({type:'POST',
            url: 'Review_status_customersmaster/edit_customers', 
			...
			<div class="utopia-widget-content">
				<form id="validation1" action="javascript:edit_customer()" class="form-horizontal editcus" >
					...
					<div class="control-group">
						...
						<div class="controls">
						<input  class="input-fluid validate[required] minw1  " id="CHNGE_NO" type="text" name='CHNGE_NO' readonly value="<?php echo ltrim($ej['CHANGENR'],"0");?>">
						<br/>
						</div>
						</div>
						<div class="control-group">
					...
					<fieldset> 
						...
						<div class="controls">
						<input  class="input-fluid minw1 " type="text" name='OBJ_TYPE' readonly value="<?php echo $ej['OBJECTTYPE'];?>"><br/>
						</div>
						</div>
						<div class="control-group">
						<label class="control-label cutz" for="date" alt='Postal Code'><?php echo Controller::customize_label('Created Date');?><span>*</span>:</label>
						<div class="controls">
						<input class="input-fluid minw1 " type="text" id='create_date' name="UDATE" readonly value="<?php echo $FD;?>"> <br/>
						</div>
						</div>
						<div class="control-group">
						<label class="control-label cutz" for="date" alt='Postal Code'><?php echo Controller::customize_label('Created Time');?><span>*</span>:</label>
						<div class="controls">
						<input class="input-fluid minw1 " type="text"  name="UTIME" readonly value="<?php echo $FT;?>"> <br/>
						</div>
						</div>
						<div class="control-group">
					...
					<fieldset> 
						...
						<div class="control-group ">
							...
							<div class="control-group">
								...
								<div class="controls">
								<input type="text" name='I_SPRAS_OLD' id='I_SPRAS_OLD' class="input-fluid getval radius read" value="<?php echo $items['LANGUAGE']['OLD'];?>" />
					...
					<fieldset>
						...
						<input  class="input-fluid validate[required] minw1  NAME" placeholder="New Name" type="text" name='NAME_NEW' readonly value='<?php echo $items['NAME']['NEW'];?>'>
						...
						<div class="control-group">
						<input  class="input-fluid  validate[required] minw1 CITY" type="text" placeholder="New City" readonly name="CITY_NEW" value="<?php echo $items['CITY']['NEW'];?>">
						
						</div>
						<div class="control-group">
						<input  class="input-fluid validate[required] minw1 REGION" type="text" readonly placeholder="New Region" name='REGION_NEW' value="<?php echo $items['REGION']['NEW'];?>">
					...
					<div class="span12 utopia-form-freeSpace bbr" style="padding-bottom:10px;"id="bottomform">
						<div style="padding-left:20%">
							<table><tr><td>&nbsp;</td><td>
							<?php if($_SESSION['HDR'][0]['THINUI_USER']==Yii::app()->user->getState("user_id") && $_SESSION['HDR'][0]['STATUS']=='REJECTED') {?>
