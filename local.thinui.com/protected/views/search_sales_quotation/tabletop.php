...
<div class="head_icons" style="width:872px;">
    ...
    <table cellpadding='0px' cellspacing='0px' class="table_head"><tr>
        <td><span id='mailto' tip="<?=Controller::customize_label(_SENDAMAIL);?>" class="yellow" onClick="mailto('examples_table')"></span></td>
...
<div id="exp_pop" style="display:none;" class="labl">
    ...
    <div class='csv_link exp_link tab_lit' onClick="csv('examples_table')" style='padding:1px 1px 1px 10px;'><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/csv.png">&nbsp;Csv</div>
    <div class='excel_link exp_link tab_lit' onClick="excel('examples_table')" style='padding:1px 1px 1px 10px;'><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/excel.png">&nbsp;Excel</div>
    ...
    <div class='csv_link csv_view exp_link tab_lit' onClick="csv_view('examples_table')" style='padding:1px 1px 1px 10px;'><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/csv.png">&nbsp;Csv</div>
    <div class='excel_link excel_view exp_link tab_lit' onClick="excel_view('examples_table')" style='padding:1px 1px 1px 10px;'><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/excel.png">&nbsp;Excel</div>
