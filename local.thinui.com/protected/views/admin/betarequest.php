    ...
    <div class="span2 sidebar-container" >
         ...
         <div class="nav-collapse collapse" id="nav_tab" >
            ...
            <ul class="accordion level-1">
              <li class="topli sales_dashbord active"><a  href="#" id='avl_sys_nav' onClick="shows_betarequest('avl_sys')" ><span>Beta user requests</span></a></li>
                        
                           
                        </li>
                         <li class="current sales_dashbord"><a  href="#" id='add_sys_nav' onClick="shows_feedback('add_sys')"><span>Feedback</span></a></li>
                        <li class="current sales_dashbord"><a  href="#" id='add_sys_help_nav' onClick="shows_help('add_sys_help')"><span>Help</span></a></li>
...
<div class="span10 body-container body_con" >
                ...
                <div class="span12" id="avl_sys" >
                    ...
                    <div class="tabbable">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab-below1" data-toggle="tab">Pending Request</a></li>
                            <li><a href="#tab-below2" data-toggle="tab">Approved</a></li>
                        </ul>
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab-below1">
                         <?php 
						 $data=json_decode($betajson,true);
						 unset($data['_rev']);
						 unset($data['_id']);
						 ?>
                         <table class='table table-striped table-bordered' id='hiddenTable'>
                         <thead>
                         <tr>
                         <th>Email ID</th><th>Name</th><th>Company</th><th>Code</th><th>Status</th><th>CreateDate</th>
                         </tr>
                         </thead>
                         <tbody>
                         <?php
                         ...
                         <td><?php if($values['status']=='deactive') {?>
                         <div class="v_mail btn pending" data-rel="<?php echo $keys;?>">Deactive</div>
                         <?php } ?>
 ...
 <table class='table table-striped table-bordered' id='hiddenTable'>
                         ...
                         <div class="v_mail btn sent" data-rel="<?php echo $keys;?>">Active</div>
                         <?php } ?>
                         </td>
                         <td><?php echo $values['createdDate'];?></td>
                         </tr>
...
$(document).ready(function(e) {
    $('.v_mail').click(function(){
		var thiss=$(this);
		thiss.removeClass('pending').addClass('pend_load');
		var data=thiss.attr('data-rel');
		...
		$.ajax({
			...
			{
				thiss.removeClass('pend_load').addClass('sent').html('Active');
