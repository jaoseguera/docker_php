        ...
        <table border="0" class="shaw"><tr>
            ...
            <td><table class="grf"  border="0"><tr>
                ...
                <td onClick="show_bar('t1')" style="vertical-align:bottom;cursor:pointer;background:#F9F9F9;" href="#tab1" data-toggle="tab">
                        <div style="width:80px;height:<?php echo ($rowsagt1*180)/$sut;?>px;background:#F8E7B2;width:40px;box-shadow: 5px -5px 5px #c8c8c8;border:1px solid #EDC243;border-bottom:0px;"  tip="<?=Controller::customize_label(_SALESORDER);?><br><?php echo $rowsagt1;?>" class="blue"></div>
                </td>
                <td class="gap"></td>
                <td onClick="show_bar('t2')" style="vertical-align:bottom;cursor:pointer;background:#F9F9F9;" href="#tab2" data-toggle="tab">
                        <div style="width:80px;height:<?php echo ($rowsagt2*180)/$sut;?>px;background:#cf8bcb;width:40px;box-shadow: 5px -5px 5px #c8c8c8;border:1px solid #8C4D88;border-bottom:0px;"  tip="<?=Controller::customize_label(_DELIVERYLIST);?><br><?php echo $rowsagt2;?>" class="blue"></div>
                </td>
                <td class="gap"></td>
            </tr></table></td>                      
            <td valign="top" style="padding-top:20px;padding-left:10px;"><table border="0" class="leng">
                <tr><td class="tods"></td><td  style="cursor:pointer;" onClick="show_bar('t1')" href="#tab1" data-toggle="tab"><?=_SALESORDER?></td>
                </tr>
                <tr><td class="bak"></td><td style="cursor:pointer;" onClick="show_bar('t2')" href="#tab2" data-toggle="tab"><?=_DELIVERYLIST?></td></tr>
            </table></td>
        </tr></table>
    </div>
</section></div>